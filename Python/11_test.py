...
iniciar = -0.9 * amplitud_max
# Usando el operador concatenar (+) para romper lineas largas
plt.text(35, iniciar, r'$T=2\pi\sqrt{\frac{l}{g}}=$' + f"{periodo:2.2f} sg\n"
                    + r'$f=frac{l}{T}=$' + f"{frecuencia:2.2f} hz\n"
                    + r'$\omega=2\pi f=$' + f"{angular:2.2f} radianes/sg", fontsize=9)
